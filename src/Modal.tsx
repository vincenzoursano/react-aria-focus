...
import {DismissButton, Overlay, useIsSSR, useModalOverlay} from 'react-aria';
import type {DOMAttributes, forwardRefType, GlobalDOMAttributes, RefObject} from '@react-types/shared';
...
import type { ContextValue, RenderProps, SlotProps } from 'react-aria-components';
import { OverlayTriggerStateContext, Provider, useContextProps, useRenderProps } from 'react-aria-components';
...
function ModalOverlayInner({UNSTABLE_portalContainer, ...props}: ModalOverlayInnerProps) {
  ...
  return (
    <Overlay isExiting={props.isExiting} disableFocusManagement={true} portalContainer={UNSTABLE_portalContainer}>
      <div
